...
<div class="container mt-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo base_url('Page/tambah_kategori_aksi') ?>" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label">Nama Kategori</label>
                    <input type="text" class="form-control" name="nama_kategori" id="formGroupExampleInput" required>
                </div>
