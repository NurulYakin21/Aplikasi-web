...
<div class="container mt-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo base_url('Page/tambah_pengarang_aksi') ?>" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label">Nama Pengarang</label>
                    <input type="text" class="form-control" name="nama_pengarang" id="formGroupExampleInput" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="no_telp" id="formGroupExampleInput" required>
                </div>
