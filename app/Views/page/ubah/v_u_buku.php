...
<div class="container mt-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo base_url('Page/ubah_buku_aksi') ?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" value="<?= $getbuku->id_buku; ?>" name="id_buku">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="<?= $getbuku->judul; ?>" name="judul_buku" id="formGroupExampleInput" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="<?= $getbuku->tahun_terbit; ?>" name="tahun_terbit" id="formGroupExampleInput" required>
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label">Stok</label>
                    <input type="text" class="form-control" value="<?= $getbuku->stok; ?>" name="stok" id="formGroupExampleInput" required>
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label">Harga</label>
                    <input type="text" class="form-control" value="<?= $getbuku->harga; ?>" name="harga" id="formGroupExampleInput" required>
                </div>
                <div class="mb-3">
